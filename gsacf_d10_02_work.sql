...
INSERT INTO `contents_box` (`id`, `user_id`, `username`, `content`, `comment`, `tag`, `created_at`) VALUES
...
(30, 6, 'ushio', 'コンタクトレンズ', '珍プレー好プレーの常連。いつみても笑えるw', 'central', '2022-02-24 21:59:34'),
